...
@section('content')
    ...
    <div id="guru-profile-container">
        ...
        <ul class="collection with-header" style="padding: 20px;">
            ...
            @if (session("dark") == "true")
                <button class="btn waves-effect tombol" type="submit" style="background-color: #616161;" onclick="window.location.href = '/admin/guru/baru'">Back<i class="material-icons left">navigate_before</i></button>
            @else
                <button class="btn waves-effect tombol" type="submit" style="background-color: #42a5f5;" onclick="window.location.href = '/admin/guru/baru'">Back<i class="material-icons left">navigate_before</i></button>
            @endif
        </ul>
    </div>
@endsection

...
@section('content')
    ...
    <div id="daftar-les-container">
        ...
        <form action="/daftar_kelas" method="get">
            <div style="width: 30%;">
                <input type="text" style="background-color: white; margin-right: 30px; height: 30px; padding-left: 5px;" name="name" id="" placeholder="Cari berdasarkan nama les,nama guru">
                <br>

            ...
            @if ($lesDiambil==null)
                <form action="/murid_ambil_kelas" method="get">
                    <button class="btn waves-effect green darken-1" type="submit" style="display: block; margin-left: auto; margin-right: auto; margin-top: 40px; width: 190px; font-size: 12px; padding-left: 5px; padding-right: 5px; background-color: #616161;"
                     onclick="return confirm('Apakah anda akan mengajukan permintaan untuk join di les ini?')">Ajukan Pengambilan<i class="material-icons right" style="margin-left: 5px; margin-right: 5px;">check</i></button>
                </form>
            @endif
        </div>
    </div>
